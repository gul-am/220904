...
<div class="relative overflow-hidden bg-white">
          ...
          <div class="relative px-4 pt-6 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
              <div class="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                <div class="flex w-full items-center justify-between md:w-auto"></div>
              </div>
            </nav>
          </div>
                ...
                <div class="w-full max-w-md space-y-8">
                  <div>
                    <a href="{{ route('pathway') }}">
                        <img class="mx-auto h-12 w-auto" src="" alt="Fish Trace-v3 Logo">
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full" src="{{ asset('statics/images/vessel.jpg') }}" alt="">
    </div>
  </div>
